...
//
//import com.playGG.play.ggprojectboard.config.CustomValidators;
...
//    public String joinProc(@Valid UserJoinRequestDto dto, Errors errors, Model model) {
//        if (errors.hasErrors()) {
...
//    /* 회원정보 수정 */
//    @GetMapping("/modify")
//    public String modify(@LoginUser UsersDto.Response users, Model model) {
//        if (users != null) {
