package com.playdata.springbootproject.fow.web;


import com.playdata.springbootproject.fow.DTO.InGame.BannedChampion;
import com.playdata.springbootproject.fow.DTO.InGame.CurrentGameParticipant;
...
import com.playdata.springbootproject.fow.DTO.Match.ParticipantDto;
import com.playdata.springbootproject.fow.DTO.MatchContainer;
...
//        ParticipantDto participantStart = null;
        ...
        try {
            ...
            for (int i = 0; i < 5; i++) {
                ...
                //총cs, 분당cs
                int totalCs = participantStart.get(i).getTotalMinionsKilled() + participantStart.get(i).getNeutralMinionsKilled();
